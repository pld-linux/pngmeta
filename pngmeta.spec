...
Summary(pl):	Pokazywanie metadanych z plików graficznych PNG
Name:		pngmeta
Version:	1.11
Release:	1
...
%description -l pl
Ten ma³y program filtruj±cy wyci±ga metadane z plików graficznych
PNG i wy¶wietla je w jednym z formatów: HTML, SOIF, RDF/XML lub jako
pola i warto¶ci.
